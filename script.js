...
let bm = document.querySelector(".audio");
...
counter_can = 0;
    ...
    if(counter_can==2){
        ...
        document.location.href = "other/winner.html";
       }
    ...
    let el= e.target;
        ...
        if(el.classList.contains("jar")) {
            ...
            counter++;count.textContent = counter;
        ...
        function load()  {  
            ...
            let  speed =Math.floor(Math.random() * 14)+8;
            let  speed_1 =Math.floor(Math.random() * 14)+8 ;
    ...
    new Jump(element).Run(speed_1, speed, 0, -0.5,setTimeout(music_on,100));
...
function back (){
    document.location.href = "other/game.html";
}
...
function info(){
    document.location.href = "other/info.html";
}
